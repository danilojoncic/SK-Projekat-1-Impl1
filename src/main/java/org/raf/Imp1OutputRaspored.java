...
public class Imp1OutputRaspored {
    ...
    public Imp1OutputRaspored(List<Dogadjaj> dogadjaji, Date datumPocetkaVazenja, Date datumKrajVazenjea, List<Date> datumiDesavanja) {
